...
while True:
    ...
    if event == "submit":
        ...
        if weather in (
            ...
            window["-IMAGE-"].update(f"{BASE_PATH}/symbols/sun.png")
        ...
        if weather in (
            ...
            window["-IMAGE-"].update(f"{BASE_PATH}/symbols/part sun.png")
        ...
        if weather in (
            ...
            window["-IMAGE-"].update(f"{BASE_PATH}/symbols/rain.png")
        ...
        if weather in (
            ...
            window["-IMAGE-"].update(f"{BASE_PATH}/symbols.thunder.png")

        # foggy
        if weather in ("Mist", "Dust", "Fog", "Smoke", "Haze", "Flurries"):
            window["-IMAGE-"].update(f"{BASE_PATH}/symbols/fog.png")
        ...
        if weather in (
            ...
            window["-IMAGE-"].update(f"{BASE_PATH}/symbols/snow.png")
